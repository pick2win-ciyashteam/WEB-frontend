...
export class PolicyComponent implements AfterViewInit {
  ...
  readonly sections: PolicySection[] = [
    ...
    { title: 'Cookies & Local Storage', body: 'PICK2WIN uses essential cookies and browser local storage to:<ul><li>Maintain Login Sessions</li><li>Preserve Account State</li><li>Support Platform Functionality</li><li>Improve Security</li><li>Protect User Accounts</li></ul>With user consent, PICK2WIN may also use Google Analytics and Google Ads cookies for traffic measurement and campaign performance. These non-essential cookies are not loaded if consent is rejected.<br><br>For additional information, please refer to our <a href="/cookie-policy">Cookie Policy</a>.' },
